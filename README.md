...
```
docker run -it --rm -v $(pwd):/downloads ghcr.io/jcansdale/extract-mp3 track <YouTube Music track URL>
```
Or for a playlist:
```
docker run -it --rm -v $(pwd):/downloads ghcr.io/jcansdale/extract-mp3 playlist <YouTube Music playlist URL>
```
